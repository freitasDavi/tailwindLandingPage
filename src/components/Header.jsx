        ...
        <section className="bg-Hero bg-cover bg-center py-4 md:px-24 px-4">
            ...
            <div className="flex md:flex-row flex-col gap-5 pt-20">
                <div className="flex-1">
                    <h1 className="md:text-5xl text-4xl font-semibold tracking-wide 
                        md:leading-tight leading-snug
                ...
                <div className="flex-1 flex justify-center">
                    <img src={HeroImg} alt="hero image" className="h-2/3" />
                </div>
            </div>
            <div className="bg-white shadow-2xl flex md:flex-row 
            flex-col md:-mt-24 lg:-mt-48 gap-10 md:p-14 p-10 mt-5 rounded-md">
                {
                    Info.map((info, i) => (
                        <div key={i}>
            ...
            <p className="py-10 md:text-sm text-xs text-gray-600 text-center">
